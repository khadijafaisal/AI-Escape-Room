...
from utils.helpers import draw_grid, draw_labels, draw_spawns, manhattan_distance
...
class Game:
    def __init__(self):
        ...
        self.collected_keys = set()
        self.current_level = 0
        self.key_positions = [(2, 3), (0, 2)]  # Make sure these match your level design
        self.exit_position = (2, 0)
        self.current_path = None
        self.current_path_index = 0
        self.current_challenge = None
    ...
    def check_level_completion(self):
        if not self.level_completed:  # Check if level isn't already marked as completed
            ...
            if not self.waiting_for_start:
                ...
                if (not self.current_challenge or not self.current_challenge.active) and \
                   ...
                   self.current_path_index < len(self.current_path):
                    ...
                    # Check if we're at exit with all keys
    ...
    def complete_challenge(self):
        if self.current_challenge:
            ...
            # Add the current position to collected keys
            current_pos = self.current_path[self.current_path_index - 1]
            ...
            if event.type == pygame.QUIT:
                ...
                if self.current_challenge and self.current_challenge.active:
                    if event.key == pygame.K_RETURN:
                        ...
                        if len(self.user_input) < 20:  # Limit input length
    ...
    def draw_challenge(self):
         # Create a larger semi-transparent background surface
         s = pygame.Surface((400, 250))  # Increased height
         s.set_alpha(230)
         s.fill((50, 50, 50))
         self.screen.blit(s, (25, 150))  # Moved up slightly
         ...
         # Render challenge text with wrapping
         if isinstance(self.current_challenge, Riddle):
         ...
         # Draw input box at the bottom of the challenge area
